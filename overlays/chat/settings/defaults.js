const nonPublicSettings = [
	...
	"spotify_scannableSize",
	"spotify_enableArt",
	"spotify_artSize",
	"spotify_enableArtOutline",
	"spotify_artOutlineSize",
	"spotify_overlayMargin",
	"spotify_elementSpacing",
	"spotify_enableArtOutlineProgress",
	"spotify_titleFontFamily",
	"spotify_titleFontSize",
	"spotify_titleFontWeight",
	"spotify_titleAdditionalFontWeight",
	"spotify_titleLineHeight",
	"spotify_titleTransform",
	"spotify_artistFontFamily",
	"spotify_artistFontSize",
	"spotify_artistFontWeight",
	"spotify_artistAdditionalFontWeight",
	"spotify_artistLineHeight",
	"spotify_artistTransform",
	"spotify_enableOutlineEffects",
	"spotify_outlineColor",
	"spotify_outlineSize",
	"spotify_enableShadowEffects",
	"spotify_shadowColor",
	"spotify_shadowXOffset",
	"spotify_shadowYOffset",
	"spotify_shadowBlurRadius",
	"spotify_enableBoxShadowEffects",
	"spotify_boxShadowColor",
	"spotify_boxShadowXOffset",
	"spotify_boxShadowYOffset",
	"spotify_boxShadowBlurRadius",
	"spotify_boxShadowBlurInset",
	...
	"spotify_titleColor",
	"spotify_artistColor",
	"spotify_artistColorReflectsArtColor",
	"spotify_artistGradient",
